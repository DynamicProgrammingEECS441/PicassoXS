...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PicassoXS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9PicassoXS11AppDelegate")
...
SWIFT_CLASS("_TtC9PicassoXS20DetailViewController")
...
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified Text;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9PicassoXS20FilterViewController")
@interface FilterViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified FilterTableView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC9PicassoXS13TableViewCell")
...
SWIFT_CLASS("_TtC9PicassoXS12HomeViewCell")
@interface HomeViewCell : TableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified ResultIm;
...
SWIFT_CLASS("_TtC9PicassoXS13SceneDelegate")
...
SWIFT_CLASS("_TtC9PicassoXS20UploadViewController")
@interface UploadViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified InputIm;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified FilterIm;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified OutputIm;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9PicassoXS14ViewController")
...
- (IBAction)Library:(id _Nonnull)sender;
