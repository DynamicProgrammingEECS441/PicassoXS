...
class ViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate,UITableViewDelegate, UITableViewDataSource{
    ...
    func showControllerForNormal(){
        ...
        GlobalVariables.Portrait = 0
    }
    func showControllerForPortrait(){
        performSegue(withIdentifier: "TakePortrait", sender: nil)
        GlobalVariables.Portrait = 1
    }
